...
class UsuarioDados extends Form
{
    ...
    {
        $this->setAttributes(['method' => 'post', 'class' => 'horizontal-form'])->setInputFilter(new UsuarioDadosFilter());
        ...
        $this->add(
            (new Text('matricula'))
                ->setLabel('*Matrícula:')
                ->setAttributes(array('maxLength' => 20, 'class' => 'form-control'))
